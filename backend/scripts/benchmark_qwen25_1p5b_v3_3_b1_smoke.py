#!/usr/bin/env python3
"""
V3.3-B.1 SMOKE — Qwen2.5-1.5B Semantic Validation Contract Check
================================================================

Purpose
-------
Validate the LLM output contract on 10 representative candidates before
running the full 251-candidate V3.3-B.1 benchmark.
...
BENCHMARK_VERSION = "V3.3-B.1-SMOKE"
...
DEFAULT_OUTPUT = Path(
    "/opt/investment-os/generated/restomart/"
    "benchmark_qwen25_1p5b_v3_3_b1_smoke.json"
)
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "V3.3-B.1 10-candidate Qwen semantic output-contract smoke"
        )
    )
    ...
    parser.add_argument(
        ...
        help="V3.3-B.1 smoke output JSON",
    )
