#!/usr/bin/env python3
"""
V3.3-B.2 — Qwen2.5-1.5B Semantic Validation Benchmark
================================================================
...
- The benchmark validates the binary semantic classification contract and semantic gate.
"""
...
DEFAULT_OUTPUT = Path(
    "/opt/investment-os/generated/restomart/"
    "benchmark_qwen25_1p5b_v3_3_b2_1.json"
)
...
def run(args: argparse.Namespace) -> int:
    ...
    result = {
        "benchmark": {
            ...
            "semantic_boundary_version": "field-specific-v1",
        "classification_mode": "binary_A_R",
            "semantic_boundary_version": "field-specific-v1",
            "grammar_constrained": True,
            "context_mode": CONTEXT_MODE,
            "purpose": "full_251_candidate_semantic_validation_after_boundary_smoke",
        },
        "startup": {
            "name": STARTUP_NAME,
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "V3.3-B.2.2 251-candidate Qwen2.5-1.5B semantic validation benchmark"
        )
    )
