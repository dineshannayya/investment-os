...
def test_custom_ownership(founder_factory):
    ...
    founder = founder_factory(ownership_percent=Decimal("42.50"))
...
def test_decimal_precision(founder_factory):
    ...
    founder = founder_factory(ownership_percent=Decimal("33.33"))
...
def test_single_founder_ownership(founder_factory):
    ...
    founder = founder_factory(ownership_percent=Decimal("92.00"))
...
def test_multiple_founder_distribution(
    ...
    founder_factory(startup=startup, ownership_percent=Decimal("45"))

    founder_factory(startup=startup, ownership_percent=Decimal("35"))

    total = sum(founder.ownership_percent for founder in startup.founders)
